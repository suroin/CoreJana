...
public class TestResponseCode {
    ...
    private static void DownloadPage(String url) throws Exception{

        String REMOTE_PLATFORM = System.getProperty("remote.platform", "Linux");
        String REMOTE_BROWSER = System.getProperty("remote.browser","chrome");
        System.getProperty("hub.url", "http://172.16.1.229:4444/wd/hub");

        RemoteWebDriver driver = null;

        try {
            final DesiredCapabilities capabilities = new DesiredCapabilities();
            capabilities.setBrowserName(REMOTE_BROWSER);
            capabilities.setCapability("platform", REMOTE_PLATFORM);
            LoggingPreferences logPrefs = new LoggingPreferences();
            logPrefs.enable(LogType.PERFORMANCE, Level.ALL);
            capabilities.setCapability(CapabilityType.LOGGING_PREFS, logPrefs);
            driver = new RemoteWebDriver(new URL("http://172.16.1.229:4444/wd/hub"), capabilities);
...
//            cap.setBrowserName(REMOTE_BROWSER);
//            cap.setCapability("platform", REMOTE_PLATFORM);
